...
In scope: the Go APIs, CLI, scanners, intelligence engine, React console, Quantum Security Fabric demo (`nexus/`), GitHub Action, Helm/Compose charts, and documentation as shipped in this repository. The Fabric Pages build must never render secret values or collect payment.
