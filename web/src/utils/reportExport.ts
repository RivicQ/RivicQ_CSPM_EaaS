...
<style>
  body { font-family: "Inter", "Segoe UI", Helvetica, Arial, sans-serif; color: #000000; margin: 32px; }
  h1 { color: #6d28d9; font-size: 22px; margin: 0 0 8px; }
  .sub { color: #525252; margin-bottom: 16px; }
  .disclaimer { background: #ffffff; border-left: 4px solid #7c3aed; padding: 12px 16px; margin: 16px 0; font-size: 13px; }
