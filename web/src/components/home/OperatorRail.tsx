  ...
  return (
    <Box sx={{ width: '100%' }} role="list" aria-label="Operator workflow">
      <Box sx={{ position: 'relative', height: 2, bgcolor: 'divider', mb: -3.25, mx: { xs: 2, md: 6 } }}>
        <motion.div
          style={{ height: '100%', background: '#7c3aed', transformOrigin: 'left' }}
          ...
          return (
            <Button
              ...
              sx={{
                ...
                bgcolor: isActive ? 'rgba(124,58,237,0.14)' : 'background.paper',
                borderRadius: 1,
              }}
            >
              <Box
                ...
                sx={{
                  ...
                  borderRadius: '50%',
                  mr: 1.25,
                  bgcolor: done ? '#3d9b7a' : isActive ? '#7c3aed' : '#1f1f2e',
                  flexShrink: 0,
                }}
              />
              <Box>
