...
export const CONTACTS: ContactEntry[] = [
  { email: 'revansai.ande@rivicq.com', label: 'Founder & CEO', area: 'company', purpose: 'Leadership — unpublished on public Pages', priority: true, publish: false, kind: 'leadership' },
  ...
  { email: 'info@rivicq.com', label: 'Company information', area: 'company', purpose: 'Formal introductions', priority: false, publish: false, kind: 'alias', access: 'Alias of hello@' },
  { email: 'contact@rivicq.com', label: 'Website forms', area: 'company', purpose: 'Generic prospect entry point', priority: false, publish: false, kind: 'alias', access: 'Alias of sales@ or hello@' },
  { email: 'investors@rivicq.com', label: 'Fundraising', area: 'company', purpose: 'Investor outreach and data-room requests', priority: true, publish: false, kind: 'inbox', access: 'Founder' },
  { email: 'finance@rivicq.com', label: 'Finance', area: 'company', purpose: 'Invoices, expenses, tax advisor, Zoho Books', priority: true, publish: false, kind: 'inbox', access: 'Founder and accountant only' },
  { email: 'billing@rivicq.com', label: 'Customer invoicing', area: 'company', purpose: 'Payments, subscriptions, purchase orders', priority: false, publish: false, kind: 'alias', access: 'Alias of finance@' },
  { email: 'legal@rivicq.com', label: 'Legal & conduct', area: 'company', purpose: 'NDAs, terms, IP, and Code of Conduct reports', priority: false, publish: false, kind: 'alias', access: 'Founder; conduct@ aliases here' },
  { email: 'operations@rivicq.com', label: 'Operations', area: 'company', purpose: 'Vendors, procurement, administration', priority: false, publish: false, kind: 'alias' },
  ...
  { email: 'privacy@rivicq.com', label: 'Privacy / GDPR', area: 'product', purpose: 'Data-subject requests', priority: true, publish: true, kind: 'alias', access: 'Alias of legal@ / security@ as needed' },
  ...
  { email: 'research@rivicq.com', label: 'Research', area: 'research', purpose: 'R&D proposals and academic partners', priority: true, publish: false, kind: 'inbox' },
  { email: 'grants@rivicq.com', label: 'Grants', area: 'research', purpose: 'BSS, EXIST, ZIM, EU, startup programmes', priority: true, publish: false, kind: 'inbox', access: 'Founder and operations' },
  ...
  { email: 'innovationhub@rivicq.com', label: 'Innovation Hub', area: 'innovation', purpose: 'Deep-tech programmes and founder ecosystem', priority: true, publish: false, kind: 'inbox' },
  { email: 'community@rivicq.com', label: 'Community', area: 'innovation', purpose: 'Open-source and student engagement', priority: false, publish: false, kind: 'alias', access: 'Alias of innovationhub@' },
  { email: 'events@rivicq.com', label: 'Events', area: 'innovation', purpose: 'Conferences, workshops, registrations', priority: false, publish: false, kind: 'alias', access: 'Alias of innovationhub@' },
  ...
  { email: 'partnerships@rivicq.com', label: 'Partnerships', area: 'partnerships', purpose: 'Cloud, quantum, university, and public-sector partners', priority: true, publish: false, kind: 'inbox' },
  ...
  { email: 'press@rivicq.com', label: 'Press', area: 'partnerships', purpose: 'PR, podcasts, speaking invitations', priority: false, publish: false, kind: 'alias' },
  ...
  { email: 'careers@rivicq.com', label: 'Careers', area: 'partnerships', purpose: 'Candidates, internships, advisors', priority: false, publish: false, kind: 'alias' },
