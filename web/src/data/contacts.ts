...
export const CONTACTS: ContactEntry[] = [
  ...
  { email: 'product@rivicq.com', label: 'Product', area: 'product', purpose: 'CryptoBOM / QBOM platform product questions', priority: false, publish: true, kind: 'alias', access: 'Alias of support@' },
  { email: 'success@rivicq.com', label: 'Customer success', area: 'product', purpose: 'Onboarding and account follow-up', priority: false, publish: true, kind: 'alias', access: 'Alias of support@' },
  { email: 'demo@rivicq.com', label: 'Product demos', area: 'product', purpose: 'Demo requests', priority: false, publish: true, kind: 'alias', access: 'Alias of sales@' },
  { email: 'enterprise@rivicq.com', label: 'Enterprise', area: 'product', purpose: 'Enterprise pipeline and paid assessments', priority: false, publish: true, kind: 'alias', access: 'Alias of sales@' },
  { email: 'solutions@rivicq.com', label: 'Solutions', area: 'product', purpose: 'Migration projects and solution design', priority: false, publish: true, kind: 'alias', access: 'Alias of sales@' },
  { email: 'pqc@rivicq.com', label: 'Post-quantum', area: 'product', purpose: 'PQC, CBOM, and cryptographic migration questions', priority: false, publish: true, kind: 'alias', access: 'Alias of security@ or research@' },
  { email: 'cryptography@rivicq.com', label: 'Cryptography', area: 'product', purpose: 'Cryptographic inventory and migration questions', priority: false, publish: true, kind: 'alias', access: 'Alias of security@' },
  { email: 'compliance@rivicq.com', label: 'Compliance mappings', area: 'product', purpose: 'DORA / NIS2 / CRA / BSI mapping questions — not a certification desk', priority: false, publish: true, kind: 'alias', access: 'Alias of security@' },
  { email: 'trust@rivicq.com', label: 'Trust', area: 'product', purpose: 'Security trust and disclosure coordination', priority: false, publish: true, kind: 'alias', access: 'Alias of security@' },
  ...
  { email: 'rnd@rivicq.com', label: 'R&D', area: 'research', purpose: 'Research and development coordination', priority: false, publish: true, kind: 'alias', access: 'Alias of research@' },
  { email: 'academia@rivicq.com', label: 'Academia', area: 'research', purpose: 'University MoUs and academic introductions', priority: false, publish: true, kind: 'alias', access: 'Alias of research@' },
  ...
  { email: 'programs@rivicq.com', label: 'Programmes', area: 'innovation', purpose: 'Hub programmes and workshops', priority: false, publish: true, kind: 'alias', access: 'Alias of innovationhub@' },
  { email: 'mentors@rivicq.com', label: 'Mentors', area: 'innovation', purpose: 'Mentor network coordination', priority: false, publish: true, kind: 'alias', access: 'Alias of innovationhub@' },
  { email: 'opensource@rivicq.com', label: 'Open source', area: 'innovation', purpose: 'CryptoBOM open source and GitHub contributors', priority: false, publish: true, kind: 'alias', access: 'Alias of community@' },
  { email: 'developers@rivicq.com', label: 'Developers', area: 'innovation', purpose: 'Technical community', priority: false, publish: true, kind: 'alias', access: 'Alias of community@' },
  ...
  { email: 'alliances@rivicq.com', label: 'Alliances', area: 'partnerships', purpose: 'Alliance and channel coordination', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'government@rivicq.com', label: 'Government', area: 'partnerships', purpose: 'Public-sector introductions — not a hotline', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'publicsector@rivicq.com', label: 'Public sector', area: 'partnerships', purpose: 'Critical-infrastructure partner introductions', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'europe@rivicq.com', label: 'Europe', area: 'partnerships', purpose: 'Regional coordination alias', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'india@rivicq.com', label: 'India', area: 'partnerships', purpose: 'Regional coordination alias', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'usa@rivicq.com', label: 'United States', area: 'partnerships', purpose: 'Regional coordination alias', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'asia@rivicq.com', label: 'Asia', area: 'partnerships', purpose: 'Regional coordination alias', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  { email: 'estonia@rivicq.com', label: 'Estonia', area: 'partnerships', purpose: 'Regional coordination alias', priority: false, publish: true, kind: 'alias', access: 'Alias of partnerships@' },
  ...
  { email: 'marketing@rivicq.com', label: 'Marketing', area: 'partnerships', purpose: 'Marketing collaborations', priority: false, publish: true, kind: 'alias', access: 'Alias of press@' },
  { email: 'brand@rivicq.com', label: 'Brand', area: 'partnerships', purpose: 'Brand assets and trademark questions', priority: false, publish: true, kind: 'alias', access: 'Alias of legal@ or press@' },
  { email: 'social@rivicq.com', label: 'Social', area: 'partnerships', purpose: 'Social and community collaborations', priority: false, publish: true, kind: 'alias', access: 'Alias of press@ or community@' },
  ...
  { email: 'talent@rivicq.com', label: 'Talent', area: 'partnerships', purpose: 'Hiring coordination', priority: false, publish: true, kind: 'alias', access: 'Alias of careers@' },
  { email: 'advisors@rivicq.com', label: 'Advisors', area: 'partnerships', purpose: 'Advisor introductions', priority: false, publish: true, kind: 'alias', access: 'Alias of careers@ or hello@' },
