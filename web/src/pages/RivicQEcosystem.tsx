...
const TOOLS_DATA: EcosystemTool[] = [
  ...
  // Cloud Services
  { id: 'cloud-aws', name: 'AWS Cloud Integration', category: 'service', description: 'CloudHSM cluster status, KMS key inventory, CloudTrail cryptographic event auditing.', edition: 'enterprise', status: 'enterprise_only', type: 'service', docs_url: 'https://docs.rivicq.de/aws' },
  { id: 'cloud-gcp', name: 'GCP Cloud Integration', category: 'service', description: 'Cloud KMS key management, GKE workload crypto scanning, HSM key ring attestation.', edition: 'enterprise', status: 'enterprise_only', type: 'service', docs_url: 'https://docs.rivicq.de/gcp' },
  { id: 'cloud-ibm', name: 'IBM Cloud HPCS', category: 'service', description: 'Hyper Protect Crypto Service key management, COS bucket attestation, quantum-safe key generation.', edition: 'enterprise', status: 'enterprise_only', type: 'service', docs_url: 'https://docs.rivicq.de/ibm' },
  ...
  { id: 'quantum-ibm', name: 'IBM Quantum Attestation', category: 'service', description: 'Quantum network attestation for CBOM reports — validates PQC readiness against IBM Quantum systems.', edition: 'enterprise', status: 'enterprise_only', type: 'service', docs_url: 'https://docs.rivicq.de/quantum' },
