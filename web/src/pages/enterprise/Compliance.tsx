            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={barData}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="score" fill="#5a5268" name="Score" />
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Score" dataKey="score" stroke="#5a5268" fill="#5a5268" fillOpacity={0.6} />
                </RadarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
        ...
        {dashboards.map((dashboard) => {
          ...
          return (
            <Grid item xs={12} sm={6} md={4} key={dashboard.framework}>
              <Card
                sx={{ borderLeft: `4px solid ${framework?.color || '#5a5268'}`, cursor: 'pointer' }}
