...
const Compliance: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader title="Compliance center" lede="Finding → control → regulation → evidence → remediation. Each control has a graph of related detections. Framework names are engineering mappings. This is not an audit opinion or a certification of RivicQ Graph or of RivicQ GmbH." />
      <GraphPanel
