  ...
  return (
    <div className="landing">
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
        <Mark size={36} />
        <div>
          <strong style={{ letterSpacing: '0.12em' }}>GRAPH</strong>
          <div style={{ color: 'var(--muted)', fontSize: 13 }}>RivicQ Graph</div>
        </div>
      </div>
      ...
      <div className="btn-row" style={{ marginBottom: 28 }}>
        ...
        <button type="button" className="btn" onClick={() => nav('/app/command')}>Open overview</button>
