...
| [TRADEMARKS.md](../TRADEMARKS.md) — IBM Carbon / Plex disclaimer | [editions.md](editions.md) — Community vs Enterprise |
...
UI colors follow **IBM Carbon** (Blue 60, Gray 100, Green 50) and **IBM Plex**. RivicQ is not an IBM product.
