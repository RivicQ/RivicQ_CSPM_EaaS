...
UI colors follow **rivicq.com violet** (`#8251f3`). **IBM, IBM Plex, and Carbon are trademarks of IBM. RivicQ is not an IBM product. Control mappings are not certifications.**
