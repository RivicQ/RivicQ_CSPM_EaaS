...
- CBOM scan + GitHub content analysis + Qiskit-aligned scores (local taxonomy on CBOM findings — not a QBOM product)
- BOM **view**: CBOM + SBOM; QBOM/HBOM/AIBOM/IBOM tiles locked; those APIs return 403 on Community
