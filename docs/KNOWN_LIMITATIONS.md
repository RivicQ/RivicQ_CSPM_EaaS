...
- `/fabric` is a separate labeled Quantum Security Fabric demo (wordmark FABRIC). It uses synthetic Northbridge Exchange data, never renders secret values, and does not collect payment or attach live cloud/IdP/vault credentials.
