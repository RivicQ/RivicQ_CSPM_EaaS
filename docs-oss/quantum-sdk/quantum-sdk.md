...
>
> Reference implementation: `quantum-sdk/internal/quantum/provider`, `quantum-sdk/internal/quantum/builtin`
...
|---|---|---|
| Provider contract + capabilities | OSS | `quantum-sdk/internal/quantum/provider/provider.go` |
| Registry + lifecycle + event stream | OSS | `quantum-sdk/internal/quantum/provider/registry.go` |
| Plugin manifest + ed25519 signing + loader | OSS | `quantum-sdk/internal/quantum/provider/plugin.go` |
| `local-pqc` — dependency-free local attestation | OSS | `quantum-sdk/internal/quantum/builtin` |
| `oqs-engine` — Open Quantum Safe (software backend) | OSS | `quantum-sdk/internal/quantum/oqsengine` |
| `nist-pqc` — FIPS 203/204/205 validation engine | OSS | `quantum-sdk/internal/quantum/nistpqc` |
| `ibm-quantum` — opt-in cloud provider | Enterprise | `quantum-sdk/internal/quantum/ibmquantum` |
