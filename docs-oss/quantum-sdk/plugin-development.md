...
import (
	...
	"github.com/RivicQ/RivicQ_CSPM_EaaS/quantum-sdk/quantum-sdk/internal/quantum/provider"
)
...
Follow the `ibm-quantum` reference in `quantum-sdk/internal/quantum/ibmquantum/provider.go`:
...
- `quantum-sdk/internal/quantum/provider/registry_test.go`
- `quantum-sdk/internal/quantum/provider/plugin_test.go`
- `quantum-sdk/internal/quantum/nistpqc/validate_test.go`

Run them:

```sh
(cd quantum-sdk && go test ./... -race)
```
